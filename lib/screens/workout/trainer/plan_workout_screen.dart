            ...
            children: [
              ElevatedButton(
                onPressed: () {
                  Navigator.push(context,
                    ...
                    return MultiBlocProvider(
                      ...
                      child: WorkoutTypeScreen(title: 'CHOOSE WORKOUT   I', color: Theme.of(context).colorScheme.secondary,)
                    );
                  }));
                },
                style: ElevatedButton.styleFrom(
                  ...
                  minimumSize:
                      const Size(280, 80), // Set the desired width and height
                ),
                child: Text(
                  'CHOOSE WORKOUT   I',
                ...
                onPressed: () {
                  Navigator.push(context,
                    ...
                    return MultiBlocProvider(
                      ...
                      child: WorkoutTypeScreen(title: 'CHOOSE WORKOUT   II', color: Theme.of(context).colorScheme.primary,)
                    );
                  }));
                },
                style: ElevatedButton.styleFrom(
                ...
                onPressed: () {
                  Navigator.push(context,
                    ...
                    return MultiBlocProvider(
                      ...
                      child: WorkoutTypeScreen(title: 'CHOOSE WORKOUT   III', color: Theme.of(context).colorScheme.scrim,)
                    );
                  }));
                },
                style: ElevatedButton.styleFrom(
